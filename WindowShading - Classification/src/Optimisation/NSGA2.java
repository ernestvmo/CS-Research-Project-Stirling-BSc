...
public class NSGA2
{
	...
	public void go()
	{
		...
		double selectionProbability = 1; // 1 = always pick better solution; 0 =
											// always pick worst
		double mutationProbability = 1.0 / problemSize; // probability of
		...
		long waitBetweenGens = 0; // slows down evolution if we want to display
									...
									// milliseconds)
		int numThreads = 3; // works best if pop size is a multiple of this as
	...
	{
		// init
		Set<Individual> assigned = new HashSet<Individual>(pop.length); // keep
																		// track
																		// of
																		// what's
																		// been
