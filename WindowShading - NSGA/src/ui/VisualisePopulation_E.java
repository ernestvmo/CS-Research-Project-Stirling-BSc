...
public class VisualisePopulation_E extends JFrame
{
	...
	/**
	 * Construct method for VisualisePopulation_E.
	 */
	...
	/**
	 * Construct method for VisualisePopulation_E. <br>
	 * This constructor takes the minimum fitness values to draw the limits of the axes.
	 */
	...
	/**
	 * Draw the passed population on the panel.
	 * 
	 * @param pop The updated population to represent.
	 */
...
//				int x = bounds.x + (int) (((i.getFitness1() - minFitness1) / (maxFitness1 - minFitness1)) * (bounds.width - axisOffset)) + axisOffset;
	...
	/**
	 * Creates a ListModel for the JList object in the JFrame from the passed Individual array.
	 * 
	 * @param population The population we want contained in the list.
	 * 
	 * @return The ListModel built from the passed array.
	 */
	...
	/**
	 * Rounds the passed parameters to the specified number of decimal places.
	 * 
	 * @param d The value to round.
	 * @param decimalPlaces The number of decimal places we want to display.
	 * 
